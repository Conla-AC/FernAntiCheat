execute if entity @s[tag=jump,scores={speed_y=268..},tag=!DEV_OP] run tag @s add __jump_vl__A
...
execute if entity @s[tag=__jump_vl__A] run scoreboard players add @s Jumpvl 1
