execute if block ~~~ water if entity @s[tag=moving,scores={__Iwater__=12..,speed=110..,__dead_time__=!1..,__moving__=12..},tag=!dead,tag=!DEV_OP] run tag @s add __speed_vl__E
