...
#Flag
execute if entity @s[scores={__tmp_fly_isrising=2..,__tmp_fly_isfalling=2..,speed_y=1..,__slime__=!1..}] run tellraw @a[tag=op] {"rawtext":[{"text":"§7[§bEasyAC§7] "},{"selector":"@s"},{"text":" §3failed §bFly (I) §7(vl:"},{"score":{"name":"@s","objective":"Flyvl"}},{"text":")"}]}
