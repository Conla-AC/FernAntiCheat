...
scoreboard players add @s px_d0 0
scoreboard players add @s px_d1 0
scoreboard players add @s px_d2 0
scoreboard players add @s px_d3 0
scoreboard players add @s px_d4 0
scoreboard players add @s px_d5 0
scoreboard players add @s px_d6 0
scoreboard players add @s px_d7 0
scoreboard players add @s py_d0 0
scoreboard players add @s py_d1 0
scoreboard players add @s py_d2 0
scoreboard players add @s py_d3 0
scoreboard players add @s py_d4 0
scoreboard players add @s py_d5 0
scoreboard players add @s py_d6 0
scoreboard players add @s py_d7 0
scoreboard players add @s pz_d0 0
scoreboard players add @s pz_d1 0
scoreboard players add @s pz_d2 0
scoreboard players add @s pz_d3 0
scoreboard players add @s pz_d4 0
scoreboard players add @s pz_d5 0
scoreboard players add @s pz_d6 0
scoreboard players add @s pz_d7 0
